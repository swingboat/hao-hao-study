...
| [`docs/PRD/Operator_Console_MVP_PRD.md`](./docs/PRD/Operator_Console_MVP_PRD.md) | admin端 PRD v0.1（F1–F7 共 18 个 TAV） |
| [`docs/PRD/Student_Web_MVP_PRD.md`](./docs/PRD/Student_Web_MVP_PRD.md) | web端 PRD v0.1（G1–G5 + 主旅程 V1） |
...
hao-hao-study/
├── apps/
│   ├── admin/              # admin端 Next.js（@hao/admin，端口 3001）
│   └── web/                # web端 Next.js（@hao/web，端口 3000）
├── packages/
...
# 5. 起开发服务（任选）
pnpm dev:admin     # admin端 http://localhost:3001
...
本仓库设计为 **总控 / admin端 / web端 3 个 Claude Code 进程并行**。详见 [`docs/Git_Worktree_Guide.md`](./docs/Git_Worktree_Guide.md)。
