...
/** converse-v1：原生 PDF 分片路径（analyzePdf）。chunk + final 两段共用此版本号。 */
export const KP_CONVERSE_PROMPT_VERSION = 'kp/2026-06-07-converse-v1';
...
/**
 * 终审阶段：拿所有 chunk 的 KP JSON 做去重 + 章节归并。
 * 终审产物会过 KnowledgePointBatchSchema 强校验（在 actions.ts 内），失败抛错。
 */
